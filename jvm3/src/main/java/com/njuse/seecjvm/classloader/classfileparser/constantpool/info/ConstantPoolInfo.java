    ...
    public static Pair<ConstantPoolInfo, Integer> getConstantPoolInfo(ConstantPool constantPool, byte[] classfile, int ofs) {
        ...
        switch (tag) {
            ...
            case UTF8: {
                 ...
                 * Add some codes here.
                 */
                Pair<UTF8Info, Integer> utf8InfoPair = UTF8Info.getInstance(constantPool, classfile, in.getByteBuffer().position());
                ret = utf8InfoPair.getKey();
                bytesRead += utf8InfoPair.getRight();
                break;
            }
